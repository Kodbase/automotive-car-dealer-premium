...
export async function sendBookingConfirmation({
  ...
  const { data, error } = await resend.emails.send({
    from: 'Revive Auto Lab <onboarding@resend.dev>' ,// geçici test için,
    to,
                ...
                <tr>
                  <td style="padding:40px 32px;">
                    ...
                    <p style="color:#6b7280;margin:0 0 32px;font-size:15px;">
                      Merhaba ${name}, randevunuz başarıyla oluşturuldu.
                    </p>
                    ...
                    <p style="color:#9ca3af;font-size:12px;text-align:center;margin:0 0 32px;">
                      Rezervasyon No: <span style="font-family:monospace;">${bookingId}</span>
                    </p>
              ...
              <table width="600" cellpadding="0" cellspacing="0"
                ...
                <tr>
                  <td style="padding:40px 32px;">
                    ...
                    <p style="color:#6b7280;margin:0 0 32px;font-size:15px;">
                      Merhaba ${name}, aşağıdaki randevunuz iptal edilmiştir.
                    </p>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0"
                      ...
                      <tr>
                        <td style="padding:6px 0;">
                          ...
                          <strong style="color:#1a1a1a;font-size:14px;">${plate}</strong>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding:6px 0;">
                      ...
                      <tr>
                        <td style="padding:6px 0;">
                          ...
                          <strong style="color:#1a1a1a;font-size:14px;">${reason}</strong>
                        </td>
                      </tr>` : ''}
                    </table>
                ...
                <tr>
                  <td style="padding:40px 32px;text-align:center;">
                    ...
                    <p style="color:#6b7280;margin:0 0 24px;font-size:15px;">
                      Merhaba ${name}, <strong>${plate}</strong> plakalı aracınızın durumu güncellendi.
                    </p>
                    <a href="${APP_URL}/tr/tracking"
                      style="display:inline-block;background:#1a1a1a;color:#ffffff;
...
// Kullanıcıya otomatik yanıt + işletmeye bildirim olarak iki ayrı mail gönderir.

export async function sendContactEmail({ name, email, message }) {
  const BUSINESS_EMAIL = process.env.CONTACT_RECEIVER_EMAIL

  // 1) İşletmeye bildirim maili
  ...
  // 2) Kullanıcıya otomatik yanıt maili
                ...
                <tr>
                  <td style="padding:40px 32px;text-align:center;">
                    ...
                    <p style="color:#6b7280;font-size:15px;margin:0 0 28px;line-height:1.6;">
                      Merhaba <strong>${name}</strong>, mesajınız bize ulaştı.<br>
