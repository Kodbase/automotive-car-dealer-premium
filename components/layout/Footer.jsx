...
export default function Footer() {
  ...
  const links = [
    ...
    { label: t.nav.booking, href: ROUTES.booking(lang) },
  ]
    ...
    <footer className={styles.footer}>
      ...
      <div className={styles.cta}>
        <div className={styles.ctaInner}>
          <div>
            <p className={styles.ctaTitle}>Aracınız için en iyi bakım</p>
            <p className={styles.ctaDesc}>Hemen randevu alın, farkı hissedin.</p>
          </div>
      ...
      <div className={styles.main}>
        ...
        <div className={styles.brand}>
          ...
          <p className={styles.brandDesc}>
            Premium araç bakım ve yıkama hizmetleri ile aracınızı yeniliyoruz.
          </p>
          <div className={styles.socials}>
            <a href={CONFIG.social.instagram} target="_blank" rel="noopener noreferrer" className={styles.socialBtn}>
        ...
        {/* Contact */}
        <div className={styles.col}>
          <h4 className={styles.colTitle}>{t.contact.title}</h4>
          <div className={styles.contactList}>
            <a href={`tel:${CONFIG.phone}`} className={styles.contactItem}>
      ...
      <div className={styles.bottom}>
        <p className={styles.copyright}>
          © {year} {CONFIG.siteName}. {t.footer.rights}
        </p>
